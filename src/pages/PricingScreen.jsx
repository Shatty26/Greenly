...
export default function PricingScreen() {
  ...
  const guardarPlanEnBaseDatos = async (tipoPlan) => {
    ...
    if (!user) {
      console.error("No hay un usuario autenticado para asignarle el plan.");
      return;
    }
    ...
    try {
      ...
      await updateDoc(empresaDocRef, {
        plan: tipoPlan, // Guardará "Mensual" o "Anual"
      });
      console.log(`Plan ${tipoPlan} guardado con éxito en Firestore.`);
    } catch (error) {
      console.error("Error al guardar el plan de la empresa:", error);
    }
  };
                ...
                <PayPalButtons
                  ...
                  onApprove={async (data, actions) => {
                    return actions.order.capture().then(async (details) => {
                      ...
                      // LLAMADA A FIRESTORE AGREGADA
                      await guardarPlanEnBaseDatos("Mensual");
          ...
          <div className="relative w-full max-w-sm rounded-[35px] p-6 sm:p-8 transition-all duration-300 hover:scale-105 shadow-2xl bg-gradient-to-br from-green-600 to-emerald-800">
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start gap-4">
                ...
                <p className="text-white text-base sm:text-lg leading-relaxed">
                  Reporte estadísticos de empleados
                </p>
              </div>
                ...
                <PayPalButtons
                  ...
                  onApprove={async (data, actions) => {
                    return actions.order.capture().then(async (details) => {
                      ...
                      // LLAMADA A FIRESTORE AGREGADA
                      await guardarPlanEnBaseDatos("Anual");
